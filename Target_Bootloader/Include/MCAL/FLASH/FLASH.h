...
*****************************************************************************************/
FLASH_State_t Flash_Erase_Pages(u8 Start_Page,u8 Pages_Number)__attribute__((section(".FLASH_OPERATIONS")));
...
* Available via          : FLASH.c
*****************************************************************************************/
FLASH_State_t Flash_Write_Page(u8 Page_Number,u32 Data[])__attribute__((section(".FLASH_OPERATIONS")));
FLASH_State_t Flash_Write_Data(u32 Address,u32 Data)__attribute__((section(".FLASH_OPERATIONS")));
/********************************************************************
 *  END OF FILE:  FLASH.h
********************************************************************/
#endif
